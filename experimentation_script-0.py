...
execution_params = {
    "experiment_root_path" : "/export/share/peters57dm/Verbund/deepsync/experiments/comparison402",
    ...
    "Note3" : "removing the unified label method"
    }
#endregion
...
n_experiments = len(loss_fns) * len(labels_assignment_methods) * len(datasets_loading_methods) * experiment_repetitions * N_MODELS
exp_follower = 1
