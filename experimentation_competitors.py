...
execution_params = {
    "experiment_root_path" : "/export/share/peters57dm/Verbund/deepsync/experiments/competitors302",
        ...
        for exp_i in range(experiment_repetitions):
            for i in range(N_MODELS):
                ...
                save_dict_as_json(eval_tracker.to_dict(),
                            os.path.join(experiment_directory_path, f"results_{i}.json"))
                if hasattr(com, 'neural_network_trained_'):
                    torch.save(com.neural_network_trained_.state_dict(),
